...
\begin{frame}
  \begin{itemize}
  \item mundtlig
  \item 10 eksamensspørgsmål, kendt på forhånd:

    \url{http://www.cs.aau.dk/~uli/Teaching/07/Spring/SandS/Eksamen/Foreloebig/}
  \item 20 minutters forberedelse
  \item 20 minutters eksamen
  \item hjælpemidler: ingen slides, ingen computer, ingen mobiltelefon
  \item Ekstern censor: Anders Møller, Århus

    \url{http://www.brics.dk/~amoeller/}
  \item syntaks- og semantikopgaven plus 8 andre
  \item de andre: prøveopgave
  \item prøveopgaven dækker \emph{kun en del af\/} opgavens pensum
  \item prøveopgavens besvarelse indgår \emph{som en del af\/} en samlet
    præsentation
  \end{itemize}
\end{frame}
...
\begin{frame}
  \begin{align*}
    S &\;::=\; \cdots\; \mid \texttt{begin $D_V$ $D_F$ $S$ end} \\
    a &\;::=\; \cdots\; \mid f(a) \\
    D_F &\;::=\; \texttt{function $f(x)$ is $S$ \xcancel{\grey{end}}}\,; D_F \mid \epsilon
  \end{align*}
