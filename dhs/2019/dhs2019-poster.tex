...
\begin{center}
  ...
  {\Huge Associated with CONCUR / FORMATS / FMICS}
...
\begin{minipage}[t]{.47\linewidth}
  ...
  Submission of contributions: 28 June 2019
\end{minipage}
\hfill
\begin{minipage}[t]{.45\linewidth}
  \nfont%
  \hfill {\Large \bf Invited Talks}

  \smallskip

  \begin{minipage}{.2\linewidth}
    \includegraphics[width=\linewidth, trim=0 160pt 0 0, clip]{zamani}
  \end{minipage}
  \hfill
  ...
  \hfill
  \begin{minipage}{.2\linewidth}
    \includegraphics[width=\linewidth, trim=10pt 0 10pt 0, clip]{herve}
  \end{minipage}
  ...
  % \vspace{-2ex}
  \begin{minipage}{.2\linewidth}
    \includegraphics[width=\linewidth, trim=35pt 30pt 45pt 20pt, clip]{urbain}
  \end{minipage}
  \hfill
  \begin{minipage}{.75\linewidth}
    \textbf{Xavier Urbain}
